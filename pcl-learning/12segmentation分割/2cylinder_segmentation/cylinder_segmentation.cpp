...
int main(int argc, char **argv)
{
    ...
    // 创建平面模型的分割对象并设置所有参数Create the segmentation object for the planar model and set all the parameters
    ...
    // 获取圆柱体和系数Obtain the cylinder inliers and coefficients
    seg.segment(*inliers_cylinder, *coefficients_cylinder);
    std::cerr << "Cylinder coefficients: " << *coefficients_cylinder << std::endl;

    // 将圆柱体写入磁盘Write the cylinder inliers to disk
